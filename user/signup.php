...
<div style="margin-left: 10px; margin-right: 10px; margin-top: 20px;">
  <div class="register-logo">
    <!--<a href="#">-->
        <img src="https://spatto.co/assets/images/spatto-logo.png" style="width: 200px;margin-left: auto;margin-right: auto; margin-top:0px;">
...
<!--    <p class="login-box-msg">-->
	  <h3 align="center">Consumer A/C Open </h3>
<!--	  </p>-->
...
<option value="West Bengal">West Bengal</option>
												...
												<div class="col-sm-6  pass-log-trans" style="height: 74px;">
                                                    <div class="form-group">
                                                        <label class="text-left">Recurring/Fixed Deposit for<span class="mendatory"></span></label>
                                                        <!--<input type="text" id="rd_detail" name="rd_detail" class="form-control" />-->
                                                        <select id="rd_detail" name="rd_detail" class="form-control">
                                                            <option value="">Select Reason</option>
                                                            <option>Marriage </option>
                                                            <option>Medical </option>
                                                            <option>Studies </option>
                                                            <option>Apna Ghar</option>
                                                            <option>Four Wheeler </option>
                                                            <option>Personal Saving </option>
                                                        </select>    
                                                        Note : If you avail <b>RD/FD</b> option then a separate account on your name will be opened.
                                                    </div>
                                                </div>
												
												<div class="col-sm-12  pass-log-trans">
												    <h3 style="font-size: 18px;font-weight: bold;">Nominee Details</h3>
												</div>    
												<div class="col-sm-12  pass-log-trans">
												    <hr style="border-top: 2px solid #4b900c">
												</div>    
                                               
                                                <div class="col-sm-6  pass-log-trans">
                                                    <div class="form-group">
                                                        <label class="text-left">Nominee<span class="mendatory">*</span></label>
                                                        <input type="text" id="nominee" name="nominee" class="form-control" required/>
                                                    </div>
                                                </div>
                                                
                                                <div class="col-sm-6  pass-log-trans">
                                                    <div class="form-group">
                                                        <label class="text-left">Nominee Relation<span class="mendatory">*</span></label>
                                                        <input type="text" id="nominee_relation" name="nominee_relation" class="form-control" required/>
                                                    </div>
                                                </div>
...
-->
                                                ...
                                                <div class="col-sm-12"  style="padding-top: 20px;">
                                                    <div id="divTerms" class="clearfix">
                                                        ...
                                                        <span>I Accept</span> <a id="termOfUse12" style="color:#fe6600">Term and Conditions</a>
                                                    </div>
                                                </div>

                                                <div class="col-sm-2" style="padding-top: 20px;">
                                                    <!--<button type="submit" class="btn btn-primary btn-block btn-sm offset-top-22">registration</button>-->
                                                    <button type="submit" style="background-color: #1f9810;border-color: #166e0b;" class="btn btn-primary btn-block btn-sm offset-top-22">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<br>
    <center><a href="index.php" class="text-center" style="color:#fe6600">I already have a membership</a></center>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
