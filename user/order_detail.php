...
<?php
          $oid = $_POST['oid'];
            ...
            $sql2 ="SELECT `store_name`,`name`, `state`, `city`, `address`, `pincode`, `landmark`,`username`,`phone` FROM `join_store` WHERE id = '$sid'";
              ...
              list($store_name,$name,$state,$city,$address,$pincode,$landmark,$store_username,$stre_phone)  = @mysqli_fetch_row($result2);
  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
		...
		<div id="GFG" >	    	
  			<!--<div class="alert alert-info"> <strong><?=$customer_name?> - <?=$customer_user?> &nbsp;&nbsp;&nbsp; / &nbsp;&nbsp;&nbsp;Store : <?=$store_name?> - <?=$store_username?> &nbsp;&nbsp;&nbsp; / &nbsp;&nbsp;&nbsp;  Bill No.  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  <?=date("d-m-Y",strtotime($order_date))?></strong></div>-->
  		...
  		<!--</div>-->
            <!--<div class="form-group"><br></div>-->
             ...
             <tr style="line-height: 45px; border-top: 1px solid #ccc;">
                ...
                <td align="center"><input type="text" class="form-control" style="border: 0px none; text-align: center; background-color: transparent;" name="totalprice" id="totalprice" value="<?=$total?>" readonly></td>
                <td align="center"><input type="text" class="form-control" style="border: 0px none; text-align: center; background-color: transparent;" name="gsttotalprice" id="gsttotalprice" value="<?=$total?>"  readonly></td>
            </tr> 
              ...
              <br><br>
              						...
              						?>
              						<input type="button" name="invoice" onclick="location.href='orders_history.php';" value="Back" id="invoice" class="btn btn-rose btn-round"/>
