	...
	<form data-form-output="form-output-global" data-form-type="contact" method="post" action="signup.php" class=" text-left" >
                                        ...
                                        <div class="register">
                                            ...
                                            <div class="row" style="text-align: center;">
                                                ...
                                                <img src="/user/spatto-rules-final.png" style="width:-webkit-fill-available">
                            ...
                            <!--<embed src="https://drive.google.com/viewerng/viewer?embedded=true&url=https://spatto.co/user/spatto-rules.pdf" width="380" height="575">-->
                                        ...
                                        <div style="font-size: 16px; font-weight: 700; text-decoration: none; width: 100%; margin-top: 30px;">
                                            ...
                                            <div class="col-sm-2" style="padding-top: 20px;float: none;margin-left: auto;margin-right: auto;">
                                                    ...
                                                    <button type="submit" style="color: white; cursor: pointer; font-size: 32px; font-weight: 900; transition: 0.5s; height: 80px; border-radius: 15px; background: #1f9810; display: inline-block;border: 0;width: 250px;" class="btn btn-primary btn-block btn-sm offset-top-22">Code Open </submit>
...
<br>
    <center><a href="#" style="font-size: 16px;font-weight: 700; text-decoration:none;" class="text-center">I am ready for Code Opening</a></center>
    <br>
    <br>
  </div>
  <!-- /.form-box -->
