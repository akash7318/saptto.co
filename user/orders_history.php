  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
        <div class="box-header with-border">
          <h3 class="box-title">Billed Orders</h3>
...
<!--<br>-->
  ...
  <tr>
	...
	<th align='left' scope="col">Store Name</th>
	<th align='left' scope="col">Store Code</th>
  ...
  $sno =0;
  $sql  = "SELECT `id`, `mid`, `sid`, `order_date`,`status` FROM `orders` WHERE mid = '$mid' ";
...
<tr>
    ...
    <td align='left'><?=$store_username?></td>
