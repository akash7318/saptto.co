...
$sql = "select `name`,city,state,address,pincode,landmark from `join_store` where `id` = '$sid';";           
$result = mysqli_query($s_dbid,$sql);
  ...
  <div class="content-wrapper" style="min-height: 1363px; height:1364px">
	...
	<div class=" col-sm-5" style="background: #fff">
        ...
        <div class="box-body">
              				...
              				<div class="alert alert-info"> <strong>New Order to <?=$store?> at <?=$address?> <?=$pincode?> <?=$landmark?></strong></div>
              ...
              ?>
              						...
              						<div class="form-group">
			  							...
			  							<input type="text" class="form-control" name="product_name[]" id="product_name[]" aria-describedby="product_name[]" placeholder="Product Name" style="width: 60%;float: left;">
             ...
             ?> 						
              ...
              <br><br>				
                                    ...
                                    <input type="button" name="cancel" value="Clean" id="cancel" class="btn btn-rose btn-round"/>		
              						&nbsp;&nbsp;
              						<input type="submit" name="submit" value="Hold!!" id="submit" onClick='return confirmHold()' class="btn btn-rose btn-round"/>
              						&nbsp;&nbsp;
              						</div>
