...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        My Earning
        <small>Royalty Earning</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Royalty Earning</li>
      </ol>
    </section>
	...
	<div  style="background: #fff">
        <div class="box-header with-border">
         <h3 class="box-title">Royalty Earning</h3>
        </div>
      ...
      <tbody>
		      <?php
		        $cnt=1;
		        $sql = "select `join`.name,`join`.username,`comm`,`level`,`remarks`,`ttime`,`rname` from `join`,inv_transactions where `join`.id = '$mid' and `join`.id = mid and remarks like '%Royalty Earning%';";
