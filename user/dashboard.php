...
?>
  ...
  <div class="content-wrapper">
	...
	<p>Your refer link is :  <a href="http://spatto.co/user/signup.php?ref=<?=$username?>">http://spatto.co/user/signup.php?ref=<?=$username?></a>&nbsp;&nbsp;&nbsp;  
                                                                <a href="https://www.facebook.com/sharer/sharer.php?u=http://spatto.co/user/signup.php?ref=<?=$username?>" style="color: #3b5998" target="_blank"><i class="fa fa-facebook-square fa-2x"></i></a> &nbsp;

                                <a href="https://twitter.com/intent/tweet?source=http://spatto.co/user/signup.php?ref=<?=$username?>" style="color: #00acee" target="_blank"><i class="fa fa-twitter-square fa-2x"></i></a>&nbsp;

                                <a href="whatsapp://send?text=click on the link to register : http://spatto.co/user/signup.php?ref=<?=$username?>" data-action="share/whatsapp/share" style="color: green"><i class="fa fa-whatsapp fa-2x"></i></a>
                            </p>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="active"><a href="#ph" data-toggle="tab">Last 5 Orders</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="nav-tabs-custom" style="cursor: move;height: 340px;">
                    <ul class="nav nav-tabs pull-right">
                    <li class="pull-left header" style="font-weight: bold;"><i class="fa fa-inbox"></i> Spatto Customer Details</li>
                    </ul>
