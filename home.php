            ...
            <div class="container">
                <div class="hero-inner" style="padding-top: 10px;padding-bottom: 0px;text-align: center;max-width: 100%;">
                   ...
                   <h1 style="margin: 0px;font-size: 100px;color: #fe6600;;"> Spatto </h1>  <h1 style="margin-top: 5px;font-size: 25px; line-height: 2;">
                     <span class="wow fadeInUp" data-wow-duration="1s"  data-wow-delay="0.5s">एक सर्विस प्रोवाईड़र कम्पनी है।<br> जिसका हैड ऑफिस उतराखण्ड के देहरादून मे है। <br>जो 100% ट्रांसपेंरेंट ड़ील करती है।</span><br></h1>
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <ul>
                                ...
                                <li style="list-style: disc"><p class="wow fadeInUp" data-wow-duration="2s">हम महिलाओं को सशक्त बनाना चाहते हैं। सभी महिलाओं को मुनाफा देकर आर्थिक आजादी से उनका जीवन खुशाल बनाना ही हमारा मक्सद है।</p>
        ...
        <section class="services-section bg-snow pt-140 rpt-90 pb-110 rpb-60" style="padding-top: 70px;">
            <div class="container">
                ...
                <div class="row">
                              ...
                              <h4><a href="about.php" style="color: #177fdf;">Grocery Shopping</a></h4>
                                <ul>
                                  <li style="list-style: disc;color: #c34224;">Purchase from your Local Shopping Store</li>
                                   <li style="list-style: disc;">अपने एरिया की, नजदीक की, स्थाई दुकानों से, अपनी पसंद से, घर की जरूरतों का सामान खरीदें।</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                            ...
                            <div class="service-content">
                                ...
                                <ul>
                                  ...
                                  <li style="list-style: disc;">अपनी पसन्द से, अपने घर का सामान <br>ऑर्डर करें, और पायें होम डिलीवरी <br><br></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
                            ...
                            <div class="service-content">
                                ...
                                <ul>
                                  ...
                                  <li style="list-style: disc;">ज्यादा से ज्यादा लोगों को बताएं और<br> ज्यादा मुनाफ़ा पाएं<br><br><br></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--              <li style="list-style: disc;">जल्दी ही हम अपने पैनल से Spatto ग्राहक को, मोबाइल रिचार्ज पे 10% की छूट प्रदान करेंगे</li>-->
                    <!--            </ul>-->
                    <!--        </div>-->
                        ...
                        <div class="service-item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                            ...
                            <div class="service-content">
                                ...
                                <ul>
                                  ...
                                  <li style="list-style: disc;">हम अपने, सभी ग्राहकों को, बीमा कम्पनी से, बीमे की सेवा, प्रदान कर रहे हैं<br><br></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
                            ...
                            <div class="service-content">
                                ...
                                <ul>
                                  ...
                                  <li style="list-style: disc;">भविष्य मे आने वाली जरुरत और अपनी खुवाईश और अपने मक्सद के लिये, spatto का आर्थिक मार्ग अपना सकते है</li>
                                </ul></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item wow fadeInUp" data-wow-duration="2s">
                            ...
                            <div class="service-content">
                                ...
                                <ul>
                                  ...
                                  <li style="list-style: disc;">Spatto के माध्यम से आप अपने खुद के, <br> बिजिनेस को मुफ़्त मे प्रमोट कर सकते है <br><br></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item wow fadeInUp" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeInUp;padding-bottom: 80px;">
                            ...
                            <div class="service-content">
                                ...
                                <ul>
                                  ...
                                  <li style="list-style: disc;">अपने क्षेत्र मे, Spatto से, नौकरी पाने के लिये आवेदन करें, अपना बायोडाटा हमें भेंजें - <a href="mailto:Spattoask@gmail.com"  style="color: #177fdf;">Spattoask@gmail.com</a></li>	  
                                </ul>
