...
<head>
    ...
    <title>Career || Spatto Services</title>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="contact-sidebar">
                            <div class="sidebar-widget bg-snow" style="padding: 0px;">
                                <img src="career.jpg" style="width: 120%; max-width: fit-content;">
                            </div>
<!--
                        ...
                        <form id="call-back-form" class="call-back-form" name="call-back-form" action="#" method="post">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 mb-40">        
                                    <div class="form-group">
                                        <textarea name="form-message" rows="7" class="form-control" placeholder="Detail here..."></textarea>
                                    </div>
                                </div> 
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="position" class="form-control">
                                            ...
                                            <option>Field Superviser</option>
                                        </select>    
                                    </div>
